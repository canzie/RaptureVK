...
{
    switch (id) {
        case BufferAttributeID::POSITION: return "POSITION";
        case BufferAttributeID::NORMAL: return "NORMAL";
        case BufferAttributeID::TANGENT: return "TANGENT";
        case BufferAttributeID::BITANGENT: return "BITANGENT";
        case BufferAttributeID::COLOR: return "COLOR";
        case BufferAttributeID::WEIGHTS_0: return "WEIGHTS_0";
        case BufferAttributeID::WEIGHTS_1: return "WEIGHTS_1";
        case BufferAttributeID::JOINTS_0: return "JOINTS_0";
        case BufferAttributeID::JOINTS_1: return "JOINTS_1";
        case BufferAttributeID::TEXCOORD_0: return "TEXCOORD_0";
        case BufferAttributeID::TEXCOORD_1: return "TEXCOORD_1";
