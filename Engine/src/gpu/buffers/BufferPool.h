...
struct BufferArena : public std::enable_shared_from_this<BufferArena> {
    ...
    BufferArena(uint32_t id, VmaAllocator allocator, VkDeviceSize arenaSize, BufferUsage usage, VkBufferUsageFlags usageFlags,
...
class BufferPoolManager {
  public:
    explicit BufferPoolManager(VmaAllocator allocator);
    ~BufferPoolManager();
