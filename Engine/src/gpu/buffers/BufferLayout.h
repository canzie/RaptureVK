...
struct BufferAttribute {
    ...
    {
        return (other.name == name && other.offset == offset && other.componentType == componentType && other.type == type);
    }

    bool operator!=(const BufferAttribute &other) const { return !(*this == other); }
};
