...
#include "Renderer/GI/RadianceCascades2D/RadianceCascades2D.h"
...
public:
  ...
  static std::shared_ptr<RadianceCascades2D> getRadianceCascades() { return m_radianceCascades; }
...
private:
  ...
  static std::shared_ptr<RadianceCascades2D> m_radianceCascades;
};
