...
void MaterialParameterMapper::initializeMappings() {
    ...
    addParameterVariants(ParameterID::ROUGHNESS, MaterialParameterTypes::FLOAT, {
        ...
        "roughness_value", "surface_roughness", "u_roughnessMap"
    });
    
    addParameterVariants(ParameterID::ROUGHNESS_MAP, MaterialParameterTypes::COMBINED_IMAGE_SAMPLER, {
    ...
    // Ambient Occlusion mappings
    addParameterVariants(ParameterID::AO, MaterialParameterTypes::FLOAT, {
...
std::string parameterTypeToString(MaterialParameterTypes type) {
    switch (type) {
        ...
        case MaterialParameterTypes::TEXTURE: return "texture";
        case MaterialParameterTypes::COMBINED_IMAGE_SAMPLER: return "COMBINED_IMAGE_SAMPLER";
...
std::string parameterIdToString(ParameterID id) {
    switch (id) {
        ...
        case ParameterID::METALLIC_ROUGHNESS_MAP: return "METALLIC_ROUGHNESS_MAP";
