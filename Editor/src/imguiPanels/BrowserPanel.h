...
class HierarchyNode {
  public:
    HierarchyNode(Rapture::Entity entity, const std::string &name) : entity(entity), entityName(name) {}
...
class BrowserPanel {
  ...
  private:
    ...
    // Renders a context menu for adding components to an entity
    ...
    Rapture::Entity m_renamingEntity;
